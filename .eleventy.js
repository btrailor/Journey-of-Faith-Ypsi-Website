module.exports = function (eleventyConfig) {
  ...
  // Static assets — images are synced manually via quick-update.sh to avoid iCloud deadlock
  ...
  eleventyConfig.addPassthroughCopy({
    "src/images/favicon-32x32.png": "favicon-32x32.png",
  });
  eleventyConfig.addPassthroughCopy({
    "src/images/favicon-16x16.png": "favicon-16x16.png",
  });
  eleventyConfig.addPassthroughCopy({
    "src/images/apple-touch-icon.png": "apple-touch-icon.png",
  });
  ...
  // Add date filters for calendar display
  eleventyConfig.addFilter("dateDay", (dateObj) => {
    return new Date(dateObj).toLocaleDateString("en-US", { day: "2-digit" });
  });
